...
namespace TodoTask.Infrastructure.Migrations
{
    ...
    [Migration("20231217045815_SeedDataStep1Migration")]
    partial class SeedDataStep1Migration
    {
            ...
            modelBuilder.Entity("TodoTask.Infrastructure.Persistence.Entities.DeviceEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2023, 12, 16, 23, 58, 15, 47, DateTimeKind.Local).AddTicks(3715),
                            DeletedAt = new DateTime(2023, 12, 16, 23, 58, 15, 47, DateTimeKind.Local).AddTicks(3718),
                            Name = "Iphone Driver",
                            UpdatedAt = new DateTime(2023, 12, 16, 23, 58, 15, 47, DateTimeKind.Local).AddTicks(3716)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2023, 12, 16, 23, 58, 15, 47, DateTimeKind.Local).AddTicks(3721),
                            DeletedAt = new DateTime(2023, 12, 16, 23, 58, 15, 47, DateTimeKind.Local).AddTicks(3724),
                            Name = "Iphone Client",
                            UpdatedAt = new DateTime(2023, 12, 16, 23, 58, 15, 47, DateTimeKind.Local).AddTicks(3722)
                        });
                });
            ...
            modelBuilder.Entity("TodoTask.Infrastructure.Persistence.Entities.PersonEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2023, 12, 16, 23, 58, 15, 47, DateTimeKind.Local).AddTicks(3758),
                            DeletedAt = new DateTime(2023, 12, 16, 23, 58, 15, 47, DateTimeKind.Local).AddTicks(3761),
                            DocumentNumber = "",
                            DocumentType = 0,
                            ...
                            UpdatedAt = new DateTime(2023, 12, 16, 23, 58, 15, 47, DateTimeKind.Local).AddTicks(3760)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2023, 12, 16, 23, 58, 15, 47, DateTimeKind.Local).AddTicks(3767),
                            DeletedAt = new DateTime(2023, 12, 16, 23, 58, 15, 47, DateTimeKind.Local).AddTicks(3770),
                            DocumentNumber = "",
                            DocumentType = 0,
                            ...
                            UpdatedAt = new DateTime(2023, 12, 16, 23, 58, 15, 47, DateTimeKind.Local).AddTicks(3768)
                        });
                });
            ...
            modelBuilder.Entity("TodoTask.Infrastructure.Persistence.Entities.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Blocked = false,
                            CreatedAt = new DateTime(2023, 12, 16, 23, 58, 15, 47, DateTimeKind.Local).AddTicks(3416),
                            DeletedAt = new DateTime(2023, 12, 16, 23, 58, 15, 47, DateTimeKind.Local).AddTicks(3435),
                            Email = "driver@gmail.com",
                            FullName = "User Driver",
                            Password = "$2y$10$IXH.x1KE5WHLLAC4Njsy4.tZjWVXB6L2JwZ5UHuWpLmwEQUO2qIxW",
                            UpdatedAt = new DateTime(2023, 12, 16, 23, 58, 15, 47, DateTimeKind.Local).AddTicks(3430),
                        ...
                        new
                        {
                            Id = 2,
                            Blocked = false,
                            CreatedAt = new DateTime(2023, 12, 16, 23, 58, 15, 47, DateTimeKind.Local).AddTicks(3443),
                            DeletedAt = new DateTime(2023, 12, 16, 23, 58, 15, 47, DateTimeKind.Local).AddTicks(3446),
                            Email = "client@gmail.com",
                            FullName = "User Client",
                            Password = "$2y$10$IXH.x1KE5WHLLAC4Njsy4.tZjWVXB6L2JwZ5UHuWpLmwEQUO2qIxW",
                            UpdatedAt = new DateTime(2023, 12, 16, 23, 58, 15, 47, DateTimeKind.Local).AddTicks(3445),
            ...
            modelBuilder.Entity("TodoTask.Infrastructure.Persistence.Entities.VehicleEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2023, 12, 16, 23, 58, 15, 50, DateTimeKind.Local).AddTicks(9395),
                            DeletedAt = new DateTime(2023, 12, 16, 23, 58, 15, 50, DateTimeKind.Local).AddTicks(9414),
                            DeviceId = 1,
                            PlateNumber = "12345",
                            UpdatedAt = new DateTime(2023, 12, 16, 23, 58, 15, 50, DateTimeKind.Local).AddTicks(9410)
                        });
                });
